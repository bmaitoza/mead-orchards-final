...
const LandingPage6 = ({ width, bgImage, heading, subheading1, subheading2, height, headingSize, subheadingSize, imagePosition, showButton, logoImage, showLogo }) => {

    return (
        <HomeSection2Wrapper bgImage={bgImage} height={height} imagePosition={imagePosition} width={width}>
            <LandingTextWrapper>
            <AnimatedTitle text="Tarrytown & Sleepy Hollow" fontSize="4rem" />
                <br />
